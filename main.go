...
import (
	...
	samplecontrollercontrollers "github.com/pkbhowmick/kubebuilder-sample-controller/controllers/samplecontroller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "80d7a510.example.com",
	})
	if err != nil {
	...
	if err = (&samplecontrollercontrollers.FooReconciler{
